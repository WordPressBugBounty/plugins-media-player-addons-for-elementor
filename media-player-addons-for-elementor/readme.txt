...
* Easy to use: Creating and embedding media players using this addon is fast and easy. Just install the Elementor Plugin and activate the add-ons to get started.
* Playlist: Create Playlists of videos and audio and embed them into your pages/posts. Also, you can put them in other areas of WordPress that are supported by Elementor.
* Favorable: Play all the popular media files such as .mp3, .mp4, .AVI, .mov, .ogg, .webM, .m3u8, .m3u and more. The playlist supports a combined file format.
* Picture-in-Picture: Supports picture-in-picture mode for Videos. It supports the plays inline attribute too.
* Multiple captions: Support for multiple caption tracks/subtitles. Which increases the accessibility of your content.
* Responsive: Each Player can rescale itself to preserve the user experience and look and feel across all devices.
* Translation Ready: POT files are available with the plugin to translate with your WordPress language setup.
